package com.level1gamer.topdowncar;
...
public class Car {
	...
	public Car(World world, float width, float length, Vector2 position,
		...
		super();		
		this.steer = TopDownCar.STEER_NONE;
		this.accelerate = TopDownCar.ACC_NONE;
	...
	public void update (float deltaTime){
        ...
        if((this.accelerate==TopDownCar.ACC_ACCELERATE) && (this.getSpeedKMH() < this.maxSpeed)){
        	baseVector= new Vector2(0, -1);
        }
        else if(this.accelerate==TopDownCar.ACC_BRAKE){
        ...
        else if (this.accelerate==TopDownCar.ACC_NONE ) {
